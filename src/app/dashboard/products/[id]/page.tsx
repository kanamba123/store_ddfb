...
export default function EditVariantForm() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-4 sm:p-6 mt-2 bg-[var(--color-bg-primary)] text-[var(--color-text-primary)] shadow-md dark:shadow-lg rounded-lg ">
      {submitted && (
      ...
      <h1 className="text-2xl font-bold mb-6 text-center">Modifier une Variante de Produit</h1>
