  ...
  return (
    <div className="p-6 dark:bg-gray-900 ">
      ...
      <input
        ...
        className="mb-6 w-full max-w-md px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-400 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:placeholder-gray-400"
      />
          ...
          <table className="min-w-full bg-white dark:bg-gray-800 shadow rounded-lg overflow-hidden dark:shadow-none">
            ...
            <tbody>
              {filteredSales.map((sale) => (
                ...
                >
                  <td className="px-6 py-4 dark:text-gray-300">{sale.id}</td>
                  ...
                  <td className="px-6 py-4 text-right font-medium dark:text-gray-300">
