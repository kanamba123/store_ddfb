        ...
        <div className="overflow-x-auto">
          <table className="min-w-full bg-white shadow rounded-lg overflow-hidden">
            <thead className="bg-gray-50">
              <tr>
                <th className="text-left px-6 py-3 text-gray-700 font-semibold">ID</th>
                <th className="text-left px-6 py-3 text-gray-700 font-semibold">Nom complet</th>
                <th className="text-left px-6 py-3 text-gray-700 font-semibold">Email</th>
                <th className="text-left px-6 py-3 text-gray-700 font-semibold">Rôle</th>
                <th className="text-left px-6 py-3 text-gray-700 font-semibold">Inscrit depuis</th>
                <th className="text-right px-6 py-3 text-gray-700 font-semibold">Ventes réalisées</th>
            ...
            <tbody>
              {users.map((user) => (
                <tr key={user.id} className="border-b last:border-none hover:bg-gray-50 transition">
                  ...
                  <td className="px-6 py-4">{new Date(user.registeredAt).toLocaleDateString('fr-FR')}</td>
                  <td className="px-6 py-4 text-right">{user.salesCount}</td>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
          <div className="bg-white rounded-xl shadow-lg max-w-md w-full p-6 relative">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <label htmlFor="salesCount" className="block text-sm font-medium text-gray-700">
                  Ventes réalisées
                </label>
                <input
                  id="salesCount"
