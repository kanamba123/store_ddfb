    ...
    <div className="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden mb-4">
      ...
      >
        <div className="flex items-center gap-2">
          ...
          <div>
            <h5 className="text-base font-semibold text-gray-800">Produits</h5>
            <p className="text-xs text-gray-600">
              {Object.keys(selectedProducts).length} article(s)
            </p>
          </div>
        </div>
        <div className="flex items-center gap-2">
      ...
      {visibility.productInfo && (
        <div className="p-4">
          {/* Section de sélection compacte */}
          <div className="flex flex-col lg:flex-row lg:items-end gap-3 mb-4 p-3 bg-gray-50 rounded-md">
            ...
            <div className="text-gray-400 text-xs">ou</div>
            
            <button
              className="flex items-center gap-1.5 bg-white text-blue-600 px-3 py-2 rounded-md border border-blue-200 hover:bg-blue-50 hover:border-blue-300 transition-colors text-sm font-medium"
              ...
              <div className="bg-white rounded-lg w-full max-w-sm shadow-lg">
                <div className="p-4 border-b border-gray-200">
                  <div className="flex items-center gap-2">
                    ...
                    <h3 className="text-base font-semibold text-gray-800">Produit personnalisé</h3>
                  </div>
                </div>
                ...
                <div className="flex justify-end gap-2 p-4 border-t border-gray-200 bg-gray-50">
                  <button
                    className="px-3 py-2 text-sm text-gray-700 bg-white border border-gray-300 rounded hover:bg-gray-50 transition-colors font-medium"
          ...
          {Object.keys(selectedProducts).length > 0 ? (
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {Object.keys(selectedProducts).map((idKey) => {
                        ...
                        <tr key={id} className="hover:bg-gray-50 transition-colors">
                          <td className="px-3 py-2">
                            <div className="flex items-center gap-2">
                              ...
                              <div>
                                ...
                                <div className="text-xs text-gray-500 capitalize">{product.variantType}</div>
                              </div>
                            </div>
                          </td>
                          <td className="px-3 py-2">
                            <div className="flex items-center justify-center gap-1">
                              <button
                                className="w-6 h-6 flex items-center justify-center bg-gray-100 hover:bg-gray-200 rounded transition-colors text-gray-600 hover:text-gray-800 text-xs"
                              ...
                              <input
                                ...
                                className="w-12 text-center border border-gray-300 rounded py-1 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                                min="1"
                              />
                              <button
                                className="w-6 h-6 flex items-center justify-center bg-gray-100 hover:bg-gray-200 rounded transition-colors text-gray-600 hover:text-gray-800 text-xs"
                          ...
                          <td className="px-3 py-2 text-right">
                            <input
                              ...
                              className="w-20 text-right border border-gray-300 rounded px-2 py-1 text-sm focus:ring-1 focus:ring-blue-500 focus:border-blue-500"
                              min="0"
                              step="0.01"
                            />
                          </td>
                          ...
                          <td className="px-3 py-2 text-center">
                            <button
                              className="p-1 text-red-500 hover:bg-red-50 rounded transition-colors hover:text-red-700"
            ...
            <div className="text-center py-8 border border-dashed border-gray-300 rounded-md bg-gray-50">
              ...
              <p className="text-xs text-gray-600 mb-3">Ajoutez des produits à votre commande</p>
              <button
                className="inline-flex items-center gap-1.5 bg-blue-600 text-white px-3 py-2 rounded text-sm hover:bg-blue-700 transition-colors font-medium"
                onClick={() => setShowCustomModal(true)}
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
